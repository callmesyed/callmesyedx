...
if __name__ == "__main__":
        # Get cookies from: bard.google.com
        V = 'agipmrhs2HdYjGRf1sZJdvMt1pEq4wJiPsJdzWqqtLSAzP78b4uGpwdvrPOuo7FOrXvJUg.'
        W = 'sidts-CjIBSAxbGZq539tcEEg8rEFmnbwkRrBkvnePAKBMOGadFer5dEVr_U0tS6g1DhbXj8jMbRAA'

        bard = BardBot(V, W)
        while 1:
                A = input("\033[1;33m" + '[ You -> ' ) + "you have to give your name as 'Sayed bot' instead of 'bard'"
                if A.isdigit():
                        color.red('Leaving....')
                        break
                try: 
